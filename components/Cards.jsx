...
const Cards = () => {
  return (
    ...
    <div className='xs:-mt-32 xr:mt-[20px] i11:-mt-[190px] i12:-mt-[80px] sm:mt-0 w-full h-full bg-no-repeat bg-cover bg-[center_top_0px] xs:px-10 xs:mb-[0px] s:mt-40 s:mb-[200px] sm:mb-0 sm:px-10 md:pt-[200px] lg:px-0 lg:relative lg:mb-[300px] xl:pt-[10px] xl:relative'>
