  ...
  return (
    ...
    <div className='w-full bg-no-repeat bg-cover bg-[center_top_0px] xs:px-4 sm:px-10 sm:mb-[100px] s:mt-32 md:-mt-[400px] lg:-mt-[350px] lg:pt-[200px] lg:pb-[520px] lg:px-0 xl:-mt-[305px] xl:py-[370px] 2xl:pt-[0px] 2xl:py-[85px] 2xl:-mt-10 2xl:pb-[0px] z-10'>
      <div className='flex flex-col items-center md:mt-[200px] lg:items-center lg:mt-[200px] lg:w-full xl:ml-[80px] xl:mb-[600px] 2xl:mb-0 xl:items-start 2xl:mt-[100px] 2xl:ml-[12%] 2k:mt-[200px]'>
        ...
        <p className={`text-white w-full font-light px-14 xs:px-0 sm:p-0 text-xl text-center lg:w-full lg:px-14 lg:text-xl lg:text-left lg:text-[17px] xl:w-[90%] xl:px-0 leading-[24px] 2xl:w-[42%] ${raleway.className}`}>"The Pickle Adventure team works every day to achieve the highest quality and usefulness of the product in the ecosystem, behind the scenes of Pickle Adventure we try to make a Bluechip project with a long-term perspective.
