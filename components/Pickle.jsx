...
const Pickle = () => {
  return (
    ...
    <div className='w-full h-full bg-no-repeat bg-cover bg-[center_top_0px] s:mb-[300px] sm:-mt-[100px] lg:relative xl:relative xl:mt-[200px] 2xl:mt-[130px] 2xl:pt-[600px]'>
      <div className='text-white text-center px-14 i14:pt-[120px] xs:px-4 lg:text-left lg:px-0 lg:ml-16 xl:ml-[80px] 2xl:ml-[230px] w-full lg:w-[100%]'>
