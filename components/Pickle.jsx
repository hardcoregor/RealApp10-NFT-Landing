  ...
  return (
    ...
    <div className='w-full h-full bg-no-repeat bg-cover bg-[center_top_0px] s:mb-[300px] sm:-mt-[100px] lg:relative lg:px-14 xl:relative xl:mt-[200px] 2xl:mt-[130px] 2xl:pt-[600px]'>
      <div className='text-white text-center px-14 i14:pt-[120px] xs:px-10 sm:relative md:relative lg:text-left lg:px-0 xl:ml-[80px] 2xl:ml-[230px] w-full lg:w-[100%]'>
        ...
        <p className={`mt-[20px] lg:mt-[375px] font-light text-2xl mb-0 xs:mb-40  xs:w-[105%] xs:text-[15px] xs:leading-[133%] xs:text-left sm:w-full sm:text-center sm:text-2xl sm:mt-[400px] md:mt-[250px] lg:text-2xl leading-[35px] lg:leading-[27px] lg:pt-[220px] lg:text-[20px] xl:absolute xl:text-[16px] xl:-top-[1230px] xl:w-[55%] xl:mb-40 2xl:text-lg 2xl:-mt-[50px] 2xl:-top-[410px] 2xl:w-[40%] 2k:-top-[130px] ${raleway.className}`}>
