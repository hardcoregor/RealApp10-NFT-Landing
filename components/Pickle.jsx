...
const Pickle = () => {
  return (
    ...
    <div className='w-full h-full bg-no-repeat bg-cover bg-[center_top_0px] lg:pb-[280px]'>
      <div className='text-white text-center lg:text-left mt-[170px] lg:pt-[300px] px-14 lg:px-0 lg:ml-[190px] w-full lg:w-[38%]'>
        <h1 className='text-7xl'>The Project</h1>
        <p className={`mt-[41px] font-thin text-2xl lg:text-[20px] leading-[35px] lg:leading-[27px] ${raleway.className}`}>The Pickle Adventure project is the first step in the creation of the Empty Jar ecosystem that we are building on the Solana blockchain. The ecosystem will bring together different projects, mechanics and applications that will be linked by one token and one universe.</p>
        <p className={`mt-[20px] font-thin text-2xl lg:text-[20px] leading-[35px] lg:leading-[27px] ${raleway.className}`}>
