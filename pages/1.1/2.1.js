...
const twoOne = () => {
  return (
    <div className="bg-twoOne bg-cover bg-no-repeat bg-[center_top_0px] w-screen h-screen">
      <div className="flex w-full justify-center pt-[50%] sm:pt-[30%] md:pt-[20%] lg:pt-[10%] xl:pt-[15%]">
        ...
        >
          You find yourself in a trash can and you hear something moving in the
          trash
        </h3>
      </div>

      <div className="flex flex-col xl:flex-row xl:flex-wrap w-full text-center text-white justify-center mt-[10%] lg:mt-0 xl:mt-[5%] xl:px-[0px]">
