...
const threeFour = () => {
  ...
  return (
    <div className="relative">
      ...
      <div className="relative bg-threeFive bg-contain bg-no-repeat bg-[center_top_0px] h-screen">
      <div class="absolute inset-0 bg-gradient-to-b from-transparent to-black" />
        ...
        <div className="flex w-full justify-center pt-[40%] sm:pt-[30%] md:pt-[20%] lg:pt-[10%] xl:pt-[10%] relative">
          <h3
            className={`text-white ${raleway.className} font-medium text-[30px] xs:w-full md:text-[45px] lg:text-[60px] leading-tight w-1/2 md:w-[90%] lg:w-[80%] xl:w-[50%] text-center select-none`}
          >
